...
int main(void) {
    ...
    double t=0, dt=1000, day=86400, year=365, start, stop, timer;           // time & orbit settings
    ...
    x[9]=39.48*au,      m[9]=1.303e22;    // Pluto
